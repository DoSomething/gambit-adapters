...
module.exports.fetchCampaigns = function (environmentName) {
  ...
  return new Promise((resolve, reject) => {
    const groupsUri = 'https://secure.mcommons.com/groups';
    ...
    return gambitCampaigns.index(environmentName)
      .then((response) => {
        ...
        response.body.data.forEach((campaign, index) => {
          ...
          const groups = `Doing: ${groupsUri}/${campaign.mobilecommons_group_doing}\n` +
                         `Completed: ${groupsUri}/${campaign.mobilecommons_group_completed}\n`;
